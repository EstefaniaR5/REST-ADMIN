...
const URL_MAIN ='http://localhost:8080/restaurante/platillos/'; //URL a donde se hace la petición
            ...
            Array.from(json).forEach((p, index) => { //Toma el JSON, si es un arreglo haces el forEach. Si no lo es, mandas el error.
                ...
                <div class="col-md-4">
                    <div class="card mb-4 shadow-sm">
                        <img class="bd-placeholder-img card-img-top" role="img" src="assets/img/${p.url_imagen}" />
                        <div class="card-body">
